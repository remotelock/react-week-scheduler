...
var createPageMapCoordsToContainer = function createPageMapCoordsToContainer(
  container,
) {
...
function useClickAndDrag(ref) {
  ...
  var _useState7 = React.useState(false),
    ...
    hasFinishedDragging = _useState8[0],
    setHasFinishedDragging = _useState8[1];
  ...
  React.useEffect(
    function() {
      ...
      var touchStartWithDelay$ = touchStart$.pipe(
        operators.mergeMap(function(start) {
          return rxjs.of(start).pipe(
            operators.delay(300),
      ...
      var dragStart$ = rxjs
        .merge(mouseDown$, touchStartWithDelay$)
        .pipe(operators.map(mapCoordsToContainer));
  ...
  return {
    ...
    cancel: cancel,
    hasFinishedDragging: hasFinishedDragging,
  };
}
 ...
 */
function useMousetrap(handlerKey, handlerCallback, element) {
...
function useEventListener(ref, event, listener, options) {
  var _ref =
...
function useScrollPosition(root) {
  var _ref =
    ...
    _ref$enabled = _ref.enabled,
    enabled = _ref$enabled === void 0 ? true : _ref$enabled;
  var _useState = React.useState({ scrollTop: 0, scrollLeft: 0 }),
    _useState2 = _slicedToArray(_useState, 2),
...
function useStickyStyle(scrollParent, _ref) {
  var _ref$top = _ref.top,
    top = _ref$top === void 0 ? false : _ref$top,
    _ref$left = _ref.left,
    left = _ref$left === void 0 ? false : _ref$left;
  var _useScrollPosition = useScrollPosition(scrollParent, {
      enabled: top || left,
    }),
    scrollLeft = _useScrollPosition.scrollLeft,
  ...
  var stickyStyle = React.useMemo(
    function() {
      return {
        transform: 'translate('
          .concat(left ? scrollLeft : 0, 'px, ')
          .concat(top ? scrollTop : 0, 'px)'),
...
var getSpan = function getSpan(x1, x2) {
  return 1 + Math.abs(x2 - x1);
};
...
var createGrid = function createGrid(_ref) {
  var totalHeight = _ref.totalHeight,
    ...
    numHorizontalCells = _ref.numHorizontalCells;
  ...
  return {
    ...
    getRectFromCell: function getRectFromCell(data) {
      var endX = data.endX,
        startX = data.startX,
        endY = data.endY,
        startY = data.startY,
...
var cellToDate = function cellToDate(_ref) {
  var startX = _ref.startX,
    startY = _ref.startY,
    toMin = _ref.toMin,
    originDate = _ref.originDate;
  return dateFns.addMinutes(dateFns.addDays(originDate, startX), toMin(startY));
};

var createMapCellInfoToContiguousDateRange = function createMapCellInfoToContiguousDateRange(
  _ref,
) {
  var toMin = _ref.fromY,
    toDay = _ref.fromX,
    originDate = _ref.originDate;
  return function(_ref2) {
    ...
    return [
      dateFns.isBefore(startDate, endDate)
        ? [startDate, endDate]
        : [endDate, startDate],
    ];
  };
...
var createMapCellInfoToRecurringTimeRange = function createMapCellInfoToRecurringTimeRange(
  _ref,
) {
  var toMin = _ref.fromY,
    toDay = _ref.fromX,
  ...
  return function(_ref2) {
    ...
    var result = lodash
      ...
      .sort(function(range1, range2) {
        return dateFns.compareAsc(range1[0], range2[0]);
      });
...
var createMapDateRangeToCells = function createMapDateRangeToCells(_ref) {
  var _ref$toX = _ref.toX,
    toX =
      _ref$toX === void 0
        ? function(x) {
            return x;
  ...
  return function(_ref2) {
    ...
    var _endY =
      toY(dateFns.differenceInMinutes(end, dateFns.startOfDay(end))) - 1;
...
function mergeRanges(event) {
  return _mergeRanges(
    _toConsumableArray(event).map(function(d) {
...
function mergeEvents(event1, event2) {
  ...
  return mergeRanges(
    [].concat(_toConsumableArray(event1), _toConsumableArray(event2)),
  ).sort(function(range1, range2) {
    return dateFns.compareAsc(range1[0], range2[0]);
  });
}
...
var Cell = React__default.memo(function Cell(_ref) {
  var timeIndex = _ref.timeIndex,
    children = _ref.children,
    classes = _ref.classes,
    getDateRangeForVisualGrid = _ref.getDateRangeForVisualGrid;
  var _getDateRangeForVisua = getDateRangeForVisualGrid({
      startX: 0,
      startY: timeIndex,
      endX: 0,
      endY: timeIndex + 1,
    ...
    _getDateRangeForVisua2 = _slicedToArray(_getDateRangeForVisua, 1),
    _getDateRangeForVisua3 = _slicedToArray(_getDateRangeForVisua2[0], 1),
    start = _getDateRangeForVisua3[0];
  ...
  return React__default.createElement(
    'div',
    {
      className: classcat([
        classes.cell,
        _defineProperty({}, classes['is-hour-start'], isHourStart),
      ]),
    },
...
var dropSame = function dropSame(dates, template) {
  var takeSecond =
...
var getTextForDateRange = function getTextForDateRange(
  ...
  if (dateFns.isSameDay(start, end) && !template) {
    var _dropSame = dropSame(dates, 'a', true),
      _dropSame2 = _slicedToArray(_dropSame, 2),
      firstM = _dropSame2[0],
      secondM = _dropSame2[1];
    return ''
      .concat(dateFns.format(start, 'ddd'), ' ')
      .concat(formatHour(start))
      .concat(firstM, ' \u2013 ')
      .concat(formatHour(end))
      .concat(secondM);
  }
...
var RangeBox = React__default.memo(function RangeBox(_ref2) {
  ...
  var classes = _ref2.classes,
    ...
    cellArray = _ref2.cellArray,
    cell = _ref2.cell,
    className = _ref2.className,
    onChange = _ref2.onChange,
    cellInfoToDateRange = _ref2.cellInfoToDateRange,
    isResizable = _ref2.isResizable,
    moveAxis = _ref2.moveAxis,
    onActiveChange = _ref2.onActiveChange;
  var ref = React.useRef(null);
  var _useState = React.useState(cell),
    _useState2 = _slicedToArray(_useState, 2),
    modifiedCell = _useState2[0],
    setModifiedCell = _useState2[1];
  var originalRect = React.useMemo(
    function() {
      return grid.getRectFromCell(cell);
    },
    [cell, grid],
  );
  var rect = React.useMemo(
    function() {
      return grid.getRectFromCell(modifiedCell);
    },
    [modifiedCell, grid],
  );
  ...
  var modifiedDateRange = React.useMemo(
    function() {
      return cellInfoToDateRange(modifiedCell);
    },
    [modifiedCell],
  );
  var top = rect.top,
  ...
  var handleStop = React.useCallback(
    function() {
      if (!onChange) {
        return;
      }
  ...
  useMousetrap(
    ...
    function() {
      ...
      var newCell = _objectSpread({}, modifiedCell, {
  ...
  var handleDrag = React.useCallback(
    function(event, _ref3) {
      ...
      var _grid$getCellFromRect = grid.getCellFromRect(newRect),
        startY = _grid$getCellFromRect.startY,
        startX = _grid$getCellFromRect.startX;
  ...
  var handleResize = React.useCallback(
    function(event, direction, _ref, delta) {
      ...
      var newRect = _objectSpread({}, originalRect, newSize);
      ...
      var _grid$getCellFromRect2 = grid.getCellFromRect(newRect),
        spanY = _grid$getCellFromRect2.spanY,
        startY = _grid$getCellFromRect2.startY,
        endY = _grid$getCellFromRect2.endY;
      var newCell = _objectSpread({}, cell, {
        spanY: spanY,
        startY: startY,
        endY: endY,
  ...
  var handleOnFocus = React.useCallback(
    function() {
      if (!onActiveChange) {
        return;
      }
    ...
    React__default.createElement(
      'button',
      {
        ...
        className: classcat([
          ...
          _defineProperty(
            _ref4,
            classes['is-being-edited'],
            isBeingEdited && isBeingEdited(cell),
          ),
          _ref4),
        ]),
      ...
      React__default.createElement(
        Resizable,
        {
          size: _objectSpread({}, originalRect, {
            width: originalRect.width - 20,
          }),
          key: ''
            .concat(rangeIndex, '.')
            .concat(cellIndex, '.')
            .concat(cellArray.length, '.')
            .concat(originalRect.top, '.')
            .concat(originalRect.left),
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            'span',
            { 'aria-hidden': true, className: classes.start },
            isStart && dateFns.format(modifiedDateRange[0], 'h:mma'),
          ),

          React__default.createElement(
            'span',
            { 'aria-hidden': true, className: classes.end },
...
var Schedule = React__default.memo(function Schedule(_ref) {
  var classes = _ref.classes,
    ...
    isMovable = _ref.moveAxis,
    cellInfoToDateRange = _ref.cellInfoToDateRange,
    dateRangeToCells = _ref.dateRangeToCells,
    isBeingEdited = _ref.isBeingEdited,
    onActive = _ref.onActiveChange;
  return React__default.createElement(
    'div',
    { className: classes['range-boxes'] },
    ranges.map(function(dateRange, rangeIndex) {
      return React__default.createElement(
        'span',
        { key: rangeIndex },
        dateRangeToCells(dateRange).map(function(cell, cellIndex, cellArray) {
          return React__default.createElement(RangeBox, {
            classes: classes,
            onActiveChange: onActive,
            key: ''
              .concat(rangeIndex, '.')
              .concat(ranges.length, '.')
              .concat(cellIndex, '.')
              .concat(cellArray.length),
...
var toDay = function toDay(x) {
  return x * horizontalPrecision;
};
var toX = function toX(days) {
  return days / horizontalPrecision;
};

var TimeGridScheduler = React__default.memo(function TimeGridScheduler(_ref) {
  var _ref$verticalPrecisio = _ref.verticalPrecision,
    verticalPrecision =
      _ref$verticalPrecisio === void 0 ? 30 : _ref$verticalPrecisio,
    _ref$visualGridVertic = _ref.visualGridVerticalPrecision,
    visualGridVerticalPrecision =
      _ref$visualGridVertic === void 0 ? 30 : _ref$visualGridVertic,
    style = _ref.style,
    schedule = _ref.schedule,
    _ref$originDate = _ref.originDate,
    originDate = _ref$originDate === void 0 ? new Date() : _ref$originDate,
    classes = _ref.classes,
    className = _ref.className,
    onChange = _ref.onChange;
  var numVerticalCells = MINS_IN_DAY / verticalPrecision;
  var numHorizontalCells = 7 / horizontalPrecision;
  var toMin = React.useCallback(
    function(y) {
      return y * verticalPrecision;
    },
    [verticalPrecision],
  );

  var toY = function toY(mins) {
    return mins / verticalPrecision;
  };
  ...
  var cellInfoToSingleDateRange = React.useCallback(
    function(cell) {
      var _cellInfoToDateRanges = cellInfoToDateRanges(cell),
        _cellInfoToDateRanges2 = _toArray(_cellInfoToDateRanges),
        first = _cellInfoToDateRanges2[0],
        rest = _cellInfoToDateRanges2.slice(1);
      invariant(
        rest.length === 0,
        'Expected "cellInfoToSingleDateRange" to return a single date range, found '.concat(
          rest.length,
  ...
  var size = useComponentSize(parent);
  var _useClickAndDrag = useClickAndDrag(parent),
    dragBoxStyle = _useClickAndDrag.style,
    box = _useClickAndDrag.box,
    isDragging = _useClickAndDrag.isDragging,
    hasFinishedDragging = _useClickAndDrag.hasFinishedDragging,
    cancel = _useClickAndDrag.cancel;
  var _useState = React.useState(null),
    _useState2 = _slicedToArray(_useState, 2),
    pendingCreation = _useState2[0],
    setPendingCreation = _useState2[1];
  ...
  var _useState3 = React.useState([null, null]),
    _useState4 = _slicedToArray(_useState3, 2),
    _useState4$ = _slicedToArray(_useState4[0], 1),
    activeRangeIndex = _useState4$[0],
  ...
  var getDateRangeForVisualGrid = React.useMemo(
    function() {
      return createMapCellInfoToContiguousDateRange({
        originDate: originDate,
        fromX: toDay,
        fromY: function fromY(y) {
          return y * visualGridVerticalPrecision;
        },
      });
    },
  ...
  return React__default.createElement(
    'div',
    {
      ...
      className: classcat([
        className,
        classes.root,
        _defineProperty({}, classes['no-scroll'], isDragging),
      ]),
    },
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            'div',
            { className: classcat([classes.cell, classes.title]) },
            'T',
          ),
        ),
      ),
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        lodash.times(7).map(function(i) {
          return React__default.createElement(
            'div',
            { key: i, role: 'presentation', className: classes['day-column'] },
            React__default.createElement(
              'div',
              { className: classcat([classes.cell, classes.title]) },
      ...
      React__default.createElement(
        'div',
        { className: classes['layer-container'] },
        isDragging &&
          React__default.createElement(
            'div',
            { className: classes['drag-box'], style: dragBoxStyle },
            hasFinishedDragging &&
              React__default.createElement('div', { className: classes.popup }),
          ),
        ...
        React__default.createElement(
          'div',
          { ref: parent, role: 'grid', className: classes.calendar },
...
var classes = {
  'buttons-wrapper': 'styles-module_buttons-wrapper__96_wO',
  'no-scroll': 'styles-module_no-scroll__3IUv5',
  root: 'styles-module_root__2iNXQ',
  timeline: 'styles-module_timeline__1hCLT',
  debug: 'styles-module_debug__2eCNx',
  'debug-active': 'styles-module_debug-active__QqNIZ',
  calendar: 'styles-module_calendar__tGgRK',
  'react-draggable': 'styles-module_react-draggable__3LVqd',
  'handle-wrapper': 'styles-module_handle-wrapper__26Eew',
  handle: 'styles-module_handle__LTyBN',
  top: 'styles-module_top__3D7og',
  bottom: 'styles-module_bottom__daw_j',
  'layer-container': 'styles-module_layer-container__1wxVL',
  event: 'styles-module_event__1PixZ',
  'drag-box': 'styles-module_drag-box__3w784',
  draggable: 'styles-module_draggable__1Z1sE',
  'button-reset': 'styles-module_button-reset__1EwGq',
  'is-draggable': 'styles-module_is-draggable__176XM',
  'react-draggable-dragging': 'styles-module_react-draggable-dragging__2Kaj_',
  'is-pending-creation': 'styles-module_is-pending-creation__3Qr4x',
  'hours-container': 'styles-module_hours-container__2srEU',
  'day-column': 'styles-module_day-column__30McI',
  'day-hours': 'styles-module_day-hours__1E9lT',
  cell: 'styles-module_cell__sVJZY',
  time: 'styles-module_time__LJQW4',
  title: 'styles-module_title__2VBFp',
  'is-hour-start': 'styles-module_is-hour-start__1_0Zo',
  header: 'styles-module_header__10uIZ',
  first: 'styles-module_first__IeNvS',
  popup: 'styles-module_popup__2iu0Y',
  'range-boxes': 'styles-module_range-boxes__ib1Nb',
  'event-content': 'styles-module_event-content__3sakH',
  start: 'styles-module_start__3CzHL',
  end: 'styles-module_end__2L7Oy',
};
